...
/**
 * ImageSelectorActivity Created by Yancy on 2015/12/2.
 */
public class ImageSelectorActivity extends Activity implements ImageSelectorFragment.Callback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFragmentManager().beginTransaction().add(R.id.image_grid, Fragment.instantiate(this, ImageSelectorFragment.class.getName(), null)).commit();
