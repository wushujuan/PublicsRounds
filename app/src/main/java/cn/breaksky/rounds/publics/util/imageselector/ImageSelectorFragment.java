...
import cn.breaksky.rounds.publics.util.imageselector.adapter.FolderAdapter;
import cn.breaksky.rounds.publics.util.imageselector.adapter.ImageAdapter;
import cn.breaksky.rounds.publics.util.imageselector.bean.Folder;
import cn.breaksky.rounds.publics.util.imageselector.bean.Image;
import cn.breaksky.rounds.publics.util.imageselector.utils.FileUtils;
import cn.breaksky.rounds.publics.util.imageselector.utils.TimeUtils;

/**
 * ImageSelectorFragment Created by Yancy on 2015/12/2.
 */
public class ImageSelectorFragment extends Fragment {
	...
	private LoaderManager.LoaderCallbacks<Cursor> mLoaderCallback = new LoaderManager.LoaderCallbacks<Cursor>() {
		...
		public Loader<Cursor> onCreateLoader(int id, Bundle args) {
			if (id == LOADER_ALL) {
				CursorLoader cursorLoader = new CursorLoader(getActivity(), MediaStore.Images.Media.EXTERNAL_CONTENT_URI, IMAGE_PROJECTION, null, null, IMAGE_PROJECTION[2]
						+ " DESC");
				return cursorLoader;
			} else if (id == LOADER_CATEGORY) {
				CursorLoader cursorLoader = new CursorLoader(getActivity(), MediaStore.Images.Media.EXTERNAL_CONTENT_URI, IMAGE_PROJECTION, IMAGE_PROJECTION[0] + " like '%"
